...
Нативное Android-приложение на Kotlin + Jetpack Compose для управления шлагбаумами и воротами ELDES. Проект повторяет поведение iOS-версии из `https://github.com/lobanovsky/gate`: авторизация, регистрация, восстановление пароля, сохранённая сессия, биометрический вход и фиксированный главный экран с зонами `Двор` и `Паркинг`.
